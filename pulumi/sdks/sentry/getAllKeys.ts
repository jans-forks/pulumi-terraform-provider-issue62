...
export function getAllKeysOutput(args: GetAllKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAllKeysResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sentry:index/getAllKeys:getAllKeys", {
        "filterStatus": args.filterStatus,
        "organization": args.organization,
        "project": args.project,
    }, opts, utilities.getPackage());
