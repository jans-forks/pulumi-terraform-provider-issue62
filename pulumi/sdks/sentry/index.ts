...
export { GetAllOrganizationMembersArgs, GetAllOrganizationMembersResult, GetAllOrganizationMembersOutputArgs } from "./getAllOrganizationMembers";
export const getAllOrganizationMembers: typeof import("./getAllOrganizationMembers").getAllOrganizationMembers = null as any;
export const getAllOrganizationMembersOutput: typeof import("./getAllOrganizationMembers").getAllOrganizationMembersOutput = null as any;
utilities.lazyLoad(exports, ["getAllOrganizationMembers","getAllOrganizationMembersOutput"], () => require("./getAllOrganizationMembers"));
...
export { OrganizationRepositoryArgs, OrganizationRepositoryState } from "./organizationRepository";
export type OrganizationRepository = import("./organizationRepository").OrganizationRepository;
export const OrganizationRepository: typeof import("./organizationRepository").OrganizationRepository = null as any;
utilities.lazyLoad(exports, ["OrganizationRepository"], () => require("./organizationRepository"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "sentry:index/organizationRepository:OrganizationRepository":
                return new OrganizationRepository(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("sentry", "index/organizationRepository", _module)
