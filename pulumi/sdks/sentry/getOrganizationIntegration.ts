...
export function getOrganizationIntegrationOutput(args: GetOrganizationIntegrationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationIntegrationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sentry:index/getOrganizationIntegration:getOrganizationIntegration", {
        "name": args.name,
        "organization": args.organization,
        "providerKey": args.providerKey,
    }, opts, utilities.getPackage());
